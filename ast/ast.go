...
func (ie *InfixExpession) expressionNode()      {}
func (ie *InfixExpession) TokenLiteral() string { return ie.Token.Literal }
func (ie *InfixExpession) String() string {
	var out bytes.Buffer
	out.WriteString("(")
